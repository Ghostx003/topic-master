...
const YEAR_FILTER_OPTIONS: { id: PYQYearFilter; label: string; desc: string }[] = [
  ...
  { id: 'last_5_years', label: 'Last 5 Years', desc: '2022 – 2026 questions' },
  { id: 'last_10_years', label: 'Last 10 Years', desc: '2017 – 2026 questions' },
  { id: 'last_15_years', label: 'Last 15 Years', desc: '2012 – 2026 questions' },
