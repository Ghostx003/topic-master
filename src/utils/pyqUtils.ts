...
const KEYWORD_PYQ_RULES: { keywords: string[]; pyq: number }[] = [
  ...
  // Digital Logic
  { keywords: ['2s complement', 'signed magnitude', '1s complement', 'number representation'], pyq: 57 },
  { keywords: ['circuit output', 'propagation delay', 'glitch hazard'], pyq: 40 },
  { keywords: ['boolean algebra', 'de morgan', 'consensus theorem'], pyq: 34 },
  { keywords: ['digital counter', 'ripple counter', 'mod-n counter', 'counter'], pyq: 18 },
  { keywords: ['k map', 'karnaugh', 'prime implicant'], pyq: 17 },
  { keywords: ['min sum of products', 'sop', 'pos'], pyq: 16 },
  { keywords: ['ieee', 'floating point', 'ieee 754'], pyq: 14 },
  { keywords: ['multiplexer', 'mux', '4:1 mux', '8:1 mux'], pyq: 14 },
  { keywords: ['canonical', 'minterm', 'maxterm'], pyq: 10 },
  { keywords: ['adder', 'carry look-ahead', 'full adder'], pyq: 9 },
  { keywords: ['flip-flop', 'setup and hold', 'jk flip-flop'], pyq: 8 },

  // Operating Systems
  { keywords: ['peterson', 'critical section', 'turn variable'], pyq: 26 },
  { keywords: ['producer-consumer', 'reader-writer', 'classical sync'], pyq: 26 },
  { keywords: ['process synchronization', 'mutual exclusion', 'race condition'], pyq: 52 },
  { keywords: ['process scheduling', 'cpu scheduling', 'round robin', 'sjf', 'fcfs'], pyq: 49 },
  { keywords: ['virtual memory', 'demand paging', 'tlb', 'emat'], pyq: 43 },
  { keywords: ['page replacement', 'lru', 'fifo', 'belady anomaly'], pyq: 31 },
  { keywords: ['disk management', 'unix inode', 'inode block'], pyq: 30 },
  { keywords: ['resource allocation', 'banker algorithm', 'deadlock'], pyq: 27 },
  { keywords: ['disk scheduling', 'c-scan', 'sstf', 'look'], pyq: 16 },
  { keywords: ['semaphore', 'counting semaphore', 'wait signal'], pyq: 11 },
  { keywords: ['thread', 'threads', 'multithreading'], pyq: 10 },
  ...
  { keywords: ['generating function'], pyq: 6 },
  { keywords: ['pigeonhole'], pyq: 2 },
  ...
  { keywords: ['functions', 'injective', 'surjective', 'bijective', 'onto'], pyq: 30 },
  ...
  { keywords: ['integration', 'definite integral'], pyq: 11 },
